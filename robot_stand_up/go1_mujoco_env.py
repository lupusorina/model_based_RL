...
class Go1MujocoEnv(MujocoEnv):
    ...
    def _get_obs(self):
        ...
        dofs_position = self.data.qpos[7:].flatten() - self.model.key_qpos[2, 7:]
    ...
    def reset_model(self):
        ...
        self.data.ctrl[:] = self.model.key_ctrl[2] + self._reset_noise_scale * self.np_random.standard_normal(
